...
import {FaDiscord ,FaFacebookF,FaInstagram,FaTelegramPlane,FaTwitter,FaYoutube} from 'react-icons/fa'
...
export default function Header () {
    ...
    return (
        ...
        <div className="container-fluid">
         ...
         <div className='d-flex justify-content-center' style={{width: '73%'}}>
